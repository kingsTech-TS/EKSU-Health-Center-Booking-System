...
import { Bell, ShieldAlert, CheckCircle2, Eye, Trash2, CheckSquare, Info } from 'lucide-react'
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold font-display text-foreground flex items-center gap-3">
            <Bell className="w-8 h-8 text-primary" /> Clinic Staff Alerts
          </h1>
          <p className="text-muted-foreground mt-1">Review live notifications on queue metrics, slot capacities, and medical status releases.</p>
        </div>
          ...
          <AnimatePresence initial={false}>
            {notifications.length > 0 ? (
              ...
              <div className="p-16 text-center text-muted-foreground">
                ...
                <p className="font-bold">No active warnings or alerts.</p>
              </div>
            )}
          </AnimatePresence>
        </div>
